...
import serviceProjectsRoutes, { createPromotionAdminRouter, createServiceProjectStaffRouter } from './routes/service-projects.js';
import serviceChangesRoutes, { createServiceChangeStaffRouter } from './routes/service-changes.js';
...
app.use('/api/service-projects', serviceProjectsRoutes);
app.use('/api/notifications', notificationsRoutes);
app.use('/api/admin/service-projects', createServiceProjectStaffRouter({ readOnly: true }));
app.use('/api/support/service-projects', createServiceProjectStaffRouter());
app.use('/api/service-changes', serviceChangesRoutes);
app.use('/api/support/change-orders', createServiceChangeStaffRouter());
app.use('/api/admin/change-orders', createServiceChangeStaffRouter({ readOnly: true }));
app.use('/api/admin/promotion', createPromotionAdminRouter());

...
// 学术诚信承诺书弹窗（阶段四 4.1）
// 首次使用「研究初稿 / 表达自然度优化 / 重复表达优化」等敏感功能前强制勾选同意
      ...
      <div className="flex max-h-[90vh] w-[640px] max-w-full flex-col rounded-xl bg-white shadow-card">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 text-sm leading-relaxed text-slate-600">
          ...
          <div className="mt-3 space-y-2 text-[13px]">
            <p>1. 本平台提供的「研究初稿」「表达自然度优化」「重复表达优化」等 AI 写作辅助内容，均由人工智能模型生成，<strong>仅供学习、研究和人工修改，不得冒充为本人独立完成的学术成果直接提交</strong>。</p>
            ...
            <p>5. <strong>平台不对任何第三方学术审核或检测结果作保证</strong>，亦不承诺通过任何检测。</p>

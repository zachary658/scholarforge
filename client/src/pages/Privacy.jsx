      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-slate-700">
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pl-5">
              <li><strong>存储位置</strong>：目前账号、订单、论文资料、生成结果及备份主要存储于中国香港地区的云服务器。对于从中国境内收集后传输至香港处理的个人信息，我们将依法告知跨境处理情况、采取加密与访问控制措施，并在适用时另行取得您的单独同意。</li>
              ...
              <li><strong>导出与删除</strong>：您可通过站内功能删除项目、文档与资料；可通过平台公示的客服渠道申请查阅、复制、更正、删除、撤回同意、数据导出或账号注销。法律要求继续保存的交易记录将停止用于其他用途并受到必要保护。</li>
            </ul>
          </section>

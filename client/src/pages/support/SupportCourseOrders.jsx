  ...
  return (
    <div className="mx-auto max-w-6xl px-8 py-8">
      <div className="flex items-end justify-between">
        ...
        <button onClick={() => { load(page, status); loadOverview(); }} className="btn-ghost text-xs">
      ...
      {overview && (
        <div className="mt-4 grid grid-cols-4 gap-3">
          <div className="rounded-lg border border-slate-200 bg-amber-50 p-3">
            <div className="text-xs text-amber-600">待对接</div>
            <div className="mt-1 text-2xl font-bold text-amber-700">{overview.pending}</div>
          </div>
          <div className="rounded-lg border border-slate-200 bg-blue-50 p-3">
            <div className="text-xs text-blue-600">已对接</div>
            <div className="mt-1 text-2xl font-bold text-blue-700">{overview.contacted}</div>
          </div>
          <div className="rounded-lg border border-slate-200 bg-green-50 p-3">
            <div className="text-xs text-green-600">已完成</div>
            <div className="mt-1 text-2xl font-bold text-green-700">{overview.completed}</div>
          </div>
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
            <div className="text-xs text-slate-500">总计</div>
            <div className="mt-1 text-2xl font-bold text-slate-700">{overview.total}</div>
          </div>
        </div>
      )}

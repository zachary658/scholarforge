      ...
      <div className="grid flex-1 gap-6 lg:grid-cols-[380px_1fr]">
        ...
        <div className="card flex flex-col p-6">
          <div className="space-y-4">
            <div>
              <label className="label">研究主题 *</label>
              <textarea
            ...
            {showAdvanced && (
              <div className="space-y-4 border-l-2 border-accent-100 pl-3">
                <div>
                  <label className="label">文献时间范围</label>
                  <input
                    className="input"
                    placeholder="例如：近5年 / 2018-2023"
          ...
          <button onClick={() => run()} disabled={tool.loading} className="btn-primary w-full py-3">
            {tool.loading ? (
              ...
              <><Sparkle className="h-4 w-4" /> 生成文献综述</>
            )}
          </button>
          {tool.error && (
        ...
        <div className="card flex flex-col overflow-hidden">
          <div className="flex items-center justify-between border-b border-slate-100 px-5 py-3">
            <span className="text-sm font-medium text-slate-600">
              {form.topic ? `${form.topic} · 文献综述` : '生成结果'}
            </span>
            {result && (
          ...
          <div className="flex-1 overflow-y-auto p-6">
            {result ? (
              <div>
                ...
                {content ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="mt-4 text-sm font-medium text-ink">文献综述已生成 Word 文档</p>
                    <p className="mt-1 text-xs text-slate-400">点击右上角「下载 Word」获取完整文献综述</p>
              ...
              <div className="flex h-full flex-col items-center justify-center text-center">
                ...
                <p className="mt-4 text-sm font-medium text-slate-600">填写研究主题后生成文献综述</p>
                <p className="mt-1 text-xs text-slate-400">按主题分类梳理文献，一键导出 Word</p>
              </div>
            )}
          </div>
        </div>

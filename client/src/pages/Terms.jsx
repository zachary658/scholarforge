      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-slate-700">
          ...
          <section>
            ...
            <p className="mt-2">
              人工指导服务按报价单约定分阶段付款和交付。每一阶段的服务范围、交付物、金额、预计周期及不包含事项以用户确认时的订单快照为准；正式成果在对应阶段款项实际到账后开放。微信仅用于辅助沟通，平台订单页是报价、付款、交付和售后的唯一有效记录，用户不应向客服个人账户或个人收款码付款。
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              人工服务属于研究辅导、方法讲解、结构建议、表达修改和示例材料，不承诺“包过”“包答辩”、指定查重率或规避 AI 检测，不代替用户完成其依法或依校规应独立完成的考试、作业、论文或毕业作品。
            </p>
          </section>

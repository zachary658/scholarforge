      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-slate-700">
          <section>
            ...
            <p>
              {siteName}（以下简称"本平台"）是面向学术写作场景的 AI 辅助工具平台，提供论文大纲生成、正文撰写、文献检索与格式化、学术润色、中英翻译、重复表达优化、表达自然度优化、图表生成、格式导出等服务。本平台输出的文字、文档、图表、公式等内容均由人工智能模型生成，<strong>仅供学习与研究参考，不构成任何学术成果、专业建议或事实保证</strong>。
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              用户使用「全文生成」「表达自然度优化」「重复表达优化」等敏感功能前，须阅读并同意《学术诚信承诺书》。用户应遵守《中华人民共和国学位法》及所在学校、期刊的学术规范，<strong>不得将 AI 生成内容直接用于论文写作、作业提交、考试、投稿、查重等任何学术场景</strong>；生成文档中的参考文献、数据与图表仅供示意，请务必核实其真实性与来源后再使用。因用户违反学术规范或相关法律法规产生的后果，由用户自行承担。
            </p>
          </section>

  ...
  return (
    <DocumentGenerator
      config={{
        ...
        validate: (form) => (!form.topic.trim() ? '请填写论文题目' : !form.field ? '请选择学科专业' : null),
        fields: [
          ...
          { key: 'field', label: '学科专业', type: 'select', required: true, defaultValue: '', placeholder: '请选择学科专业', options: FIELDS },
